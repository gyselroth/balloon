...
apt-get update
apt-get install -y php7.1 php7.1-fpm php7.1-ldap php7.1-xml php7.1-mongodb php7.1-curl php7.1-imagick php7.1-mbstring php7.1-zip php7.1-intl php7.1-apcu
