...
class Document extends Controller
{
    ...
    /**
     * @api {get} /api/v1/app/office/wopi/document Get document sesssion information
     * @apiName get
     * @apiGroup App\Office
     * @apiPermission none
     ...
     * curl -XGET "https://SERVER/api/v1/app/office/wopi/document/58a18a4ca271f962af6fdbc4?access_token=aae366363ee743412abb"
     *
    ...
    /**
     * @api {post} /api/v1/app/office/wopi/document/contents Save document contents
     ...
     *
     * @apiExample (cURL) example:
     * curl -XPOST "https://SERVER/api/v1/app/office/wopi/document/58a18a4ca271f962af6fdbaa/contents?access_token=aae366363ee743412abb"
     *
     * @apiSuccessExample {json} Success-Response:
     * HTTP/1.1 200 OK
     * {
    ...
    /**
     * @api {get} /api/v1/app/office/wopi/document/contents Get document contents
     * @apiName getContents
     * @apiGroup App\Office
     * @apiPermission none
     ...
     * curl -XGET "https://SERVER/api/v1/app/office/document/58a18a4ca271f962af6fdbaa/contents?access_token=aae366363ee743412abb"
     *
