...
class User extends SimpleUser
{
    ...
    /**
     * @api {post} /api/v1/user/undelete?uid=:uid Restore user
     * @apiVersion 1.0.6
     * @apiName postUndelete
     * @apiUse _getUser
     * @apiGroup User
     * @apiPermission admin
     * @apiDescription Restore user account. This endpoint does not restore any data, it only does reactivate an existing user account.
     *
     * @apiExample Example usage:
