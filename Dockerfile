...
ARG DEV=no
RUN [ "$DEV" = "yes" ] && /srv/www/balloon/packaging/docker/bootstrap_scripts/mongodb.sh || :
RUN [ "$DEV" = "yes" ] && /srv/www/balloon/packaging/docker/bootstrap_scripts/development.sh || :
