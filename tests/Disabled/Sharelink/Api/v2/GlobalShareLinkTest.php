...
namespace Balloon\Testsuite\Unit\App\Sharelink\Api\v2;

use Balloon\App\Sharelink\Api\v2\ShareLink;
...
class GlobalShareLinkTest extends Test
{
    ...
    public function setUp()
    {
        ...
        $this->sharelink = new ShareLink($share, $server, $node_decorator);
