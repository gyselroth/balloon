...
class Search extends Controller
{
     ...
     * @return Response
     */
    public function getElasticsearch(array $query, array $attributes = [], int $deleted = 0): Response
    {
        $children = [];
        $nodes = $this->server->getApp()->getApp('Balloon.App.Elasticsearch')->search($query, $deleted);
